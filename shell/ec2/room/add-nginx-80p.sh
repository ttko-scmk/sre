...
b=$3
#exp
#sh /data/ec2/room/add-nginx-80p.sh scmk-1ap.gdb8.net nlb-scmk-sysroom-ng-b53a03165c9a11c8.elb.ap-east-1.amazonaws.com nlb-scmk-roompro-java-99048be16d90ba0f.elb.ap-east-1.amazonaws.com
...
scp  /tmp/$v.conf 10.8.219.67:/usr/local/nginx/conf/vhosts/
scp  /tmp/$v.conf 10.8.225.193:/usr/local/nginx/conf/vhosts/
