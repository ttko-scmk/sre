...
ssh root@10.8.221.196 'nginx -t' 2>&1
ssh root@10.8.221.196 'nginx -s reload' 2>&1
ssh root@10.8.231.43 'nginx -t' 2>&1
ssh root@10.8.231.43 'nginx -s reload' 2>&1
ssh root@10.8.244.234 'nginx -t' 2>&1
ssh root@10.8.244.234 'nginx -s reload' 2>&1
...
aws cloudfront create-invalidation --distribution-id E2L8A1MNU2HOAS  --paths "/" "/*"
date
