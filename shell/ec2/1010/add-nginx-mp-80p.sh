...
c=$4
#exp 專屬會員NG使用
#sh add-nginx-mp-80p.sh scmk-1mp.fbw3.net nlb-scmk-mnber-ng-87a4420d220f40f9.elb.ap-east-1.amazonaws.com nlb-scmk-portal-java-ae486c0512b72d79.elb.ap-east-1.amazonaws.com nlb-scmk-agent-java-dbe5de044d8c2688.elb.ap-east-1.amazonaws.com
...
scp  /tmp/$v.conf 10.8.221.196:/usr/local/nginx/conf/vhosts/
scp  /tmp/$v.conf 10.8.231.43:/usr/local/nginx/conf/vhosts/
scp  /tmp/$v.conf 10.8.244.234:/usr/local/nginx/conf/vhosts/
