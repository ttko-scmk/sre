#!/bin/sh
sleep 300
ssh root@10.8.217.207 'nginx -t' 2>&1
ssh root@10.8.217.207 'nginx -s reload' 2>&1
ssh root@10.8.229.5 'nginx -t' 2>&1
ssh root@10.8.229.5 'nginx -s reload' 2>&1
ssh root@10.8.243.6 'nginx -t' 2>&1
ssh root@10.8.243.6 'nginx -s reload' 2>&1
